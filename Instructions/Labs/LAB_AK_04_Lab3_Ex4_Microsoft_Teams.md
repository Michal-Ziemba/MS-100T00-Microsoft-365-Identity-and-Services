...
4. To add the blocked domain, in the **External access** window, select **Block only specific external domains** under **Choose which external domains your users have access to:**. Select **Block domains**.

5. In the **Add external domain** pane that appears on the right, enter the following information:

	- Domain: **spam.com**

6. Select **Done.**

7. In the **External access** window, validate that **spam.com** is in the list of blocked domains.
